...
from custom.decoder import Decoder, DecoderReconstructionModel, load_decoder_plan_config
from custom.decoder.dataset import RamLoadedShardDataset, inspect_feature_shards
from custom.decoder.train import evaluate, train_epoch
...
_DEFAULT_FID_STATS_PATH = "/work/nvme/betw/msalunkhe/data/custom_in256_stats.npz"
...
def get_args_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser("custom decoder", add_help=True)
    parser.add_argument(
        "--config",
        type=str,
        default=str(_DEFAULT_CONFIG_PATH),
    ...
    parser.add_argument("--wandb_project", type=str, default="custom-decoder")

...
from custom.engine_custom import _iter_accumulation_groups, train_one_epoch
...
class EngineCustomAccumulationTests(unittest.TestCase):
    ...
    def test_train_one_epoch_logs_after_optimizer_step_when_accumulating(self):
        ...
        with patch("custom.engine_custom.torch.autocast", fake_autocast):
